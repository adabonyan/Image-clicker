...
var ViewModel = function() {
	availableImages = ko.observableArray([""]);
	console.log(data().length);
	data().forEach(function(obj){
		availableImages().push(obj.name);
	})

	//chosenImage =  ko.observable("") // Initially blank

	displayChosenImage =  function() {
		myImage = new Image(chosenImage);
	};
